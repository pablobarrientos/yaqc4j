...
public class NegativeLongGenTest {
	@Test
	@Generator(klass = long.class, generator = NegativeLongGen.class)
	public void testGenerator(long negative) {
	...
	@Generator(klass = long.class, generator = NegativeLongGen.class)
	public void testGeneratorWithMinMax(long negative) {
		Assert.assertTrue(negative < 0);
	}
	...
	@Generator(klass = long.class, generator = NegativeLongGen.class)
	public void testGeneratorWithMin(long negative) {
	...
	@Generator(klass = long.class, generator = NegativeLongGen.class)
	public void testGeneratorWithMax(long negative) {
