...
package ar.edu.unlp.yaqc4j.samples.enumm;
...
public class EnumABCTest {
	@Test
	@Generator(klass = EnumABC.class, generator = EnumABCGen.class)
	public void testABC(EnumABC enumABC) {
		Assert.assertTrue(enumABC.equals(enumABC));
	}
