...
public final class LongGenTest {
	@Test
	@Generator(klass = long.class, generator = LongGen.class)
	@Configuration(maxsize = 20000000)
	public void testGeneratorMax(long l) {
		Assert.assertTrue(l <= 20000000);
	}

	@Test
	@Generator(klass = long.class, generator = LongGen.class)
	@Configuration(minsize = -10000000)
	public void testGeneratorMin(long l) {
		Assert.assertTrue(l > -10000001);
	}
