...
public class StringBuilderGenTest {
	@Test
	@Generator(klass = StringBuilder.class, generator = StringBuilderGen.class)
	@Configuration(maxsize = 20000)
	public void testGeneratorMax(StringBuilder b) {
	...
	public void testGeneratorMin(StringBuilder b) {
	...
	public void testGeneratorMinPositive(StringBuilder b) {
