...
/**
 * Arbitrary object random generator.
 * 
 * @author Pablo
 * 
 */
public class ObjectGen implements Gen<Object> {

    /**
     * @{inheritDoc
     */
    @Override
    public final Object arbitrary(final Distribution random,
	    final long minsize, final long maxsize) {
	// this method could (in theory) produce a stack overflow if object
	// class is always selected
	return Arbitrary.getRandomObject(random);
    }
