...
public final class CharacterGenTest {
	@Test
	@Generator(klass = char.class, generator = CharacterGen.class)
	@Configuration(maxsize = 200)
	public void testGeneratorMax(char c) {
		Assert.assertTrue(c <= 200);
	}

	@Test
	@Generator(klass = char.class, generator = CharacterGen.class)
	@Configuration(minsize = 100)
	public void testGeneratorMin(char c) {
		Assert.assertTrue(c > 99);
	}
