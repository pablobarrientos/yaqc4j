...
/**
 * Default StringBuilder random generator.
 * 
 * @author Pablo
 */
public final class StringBuilderGen implements Gen<StringBuilder> {
	/**
	 * the charGen.
	 */
	 ...
	 * @{inheritDoc
	 */
	public StringBuilder arbitrary(final Distribution random,
